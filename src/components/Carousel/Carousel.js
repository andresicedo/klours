            ...
            <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={carouselDetails.paintingProducts[1]} className="d-block" alt='painting products'/>
                    ...
                    <div className="carousel-item">
                        <img src={carouselDetails.stainingProducts[1]} className="d-block" alt="staining products"/>
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src={carouselDetails.concreteProducts[1]} className="d-block" alt="concrete products"/>
                        <div className="carousel-caption d-none d-md-block">
